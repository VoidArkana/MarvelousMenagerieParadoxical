...
public class LystroAnims {
	public static final AnimationDefinition WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
		...
		.addAnimation("leg_bl", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(1.0F, 0.5F, 2.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.25F, KeyframeAnimations.posVec(1.0F, 2.5F, 2.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.5F, KeyframeAnimations.posVec(1.0F, 0.0F, 0.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.0F, KeyframeAnimations.posVec(1.0F, 0.5F, 2.5F), AnimationChannel.Interpolations.CATMULLROM)
		))
		...
		.addAnimation("leg_br", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.5F, KeyframeAnimations.posVec(-1.0F, 0.5F, 2.5F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.75F, KeyframeAnimations.posVec(-1.0F, 2.5F, 2.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition EGG_LAY = AnimationDefinition.Builder.withLength(3.5F)
			...
			.addAnimation("leg_br", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.5F, KeyframeAnimations.posVec(-3.0F, 0.0F, -1.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(2.1667F, KeyframeAnimations.posVec(-3.0F, 0.0F, -1.0F), AnimationChannel.Interpolations.LINEAR),
			...
			.addAnimation("leg_fr", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(2.8333F, KeyframeAnimations.posVec(1.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
					new Keyframe(2.9583F, KeyframeAnimations.posVec(0.0F, 2.0F, -1.0F), AnimationChannel.Interpolations.LINEAR),
