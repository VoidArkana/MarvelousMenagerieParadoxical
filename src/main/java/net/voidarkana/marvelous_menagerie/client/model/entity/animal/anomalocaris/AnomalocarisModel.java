package net.voidarkana.marvelous_menagerie.client.model.entity.animal.anomalocaris;// Made with Blockbench 4.12.3
...
public class AnomalocarisModel<T extends Anomalocaris> extends MarvelousModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(AnomalocarisAnims.SWIM, limbSwing, limbSwingAmount*4f, 1.5f, 3f*entity.getInWaterMultiplier(partialTick));
