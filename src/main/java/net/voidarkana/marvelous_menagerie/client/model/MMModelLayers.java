...
public class MMModelLayers {
    ...
    public static final ModelLayerLocation BABY_SACA_LAYER =
            new ModelLayerLocation(new ResourceLocation(MarvelousMenagerie.MOD_ID, "baby_sacabambaspis"), "main");
    ...
    public static final ModelLayerLocation BABY_ARANDASPIS_LAYER =
            new ModelLayerLocation(new ResourceLocation(MarvelousMenagerie.MOD_ID, "baby_arandaspis"), "main");
    ...
    public static final ModelLayerLocation INOSTRANCEVIA_LAYER =
            new ModelLayerLocation(new ResourceLocation(MarvelousMenagerie.MOD_ID, "inostrancevia"), "main");
    public static final ModelLayerLocation BABY_INOSTRANCEVIA_LAYER =
            new ModelLayerLocation(new ResourceLocation(MarvelousMenagerie.MOD_ID, "baby_inostrancevia"), "main");
    public static final ModelLayerLocation INOSTRANCEVIA_PATTERN_LAYER =
            new ModelLayerLocation(new ResourceLocation(MarvelousMenagerie.MOD_ID, "inostrancevia_pattern"), "main");
    ...
    public static final ModelLayerLocation ANUROGNATHUS_PATTERN_LAYER =
            new ModelLayerLocation(new ResourceLocation(MarvelousMenagerie.MOD_ID, "anurognathus_pattern"), "main");
    public static final ModelLayerLocation BABY_ANUROGNATHUS_PATTERN_LAYER =
            new ModelLayerLocation(new ResourceLocation(MarvelousMenagerie.MOD_ID, "baby_anurognathus_pattern"), "main");

    public static final ModelLayerLocation KELENKEN_LAYER =
            new ModelLayerLocation(new ResourceLocation(MarvelousMenagerie.MOD_ID, "kelenken"), "main");
    ...
    public static final ModelLayerLocation ARAUCARIOXYLON_BOAT_LAYER = new ModelLayerLocation(
            new ResourceLocation(MarvelousMenagerie.MOD_ID, "boat/araucarioxylon"), "main");
