...
public class OphthalmoArmorLayer extends RenderLayer<Ophthalmosaurus, MarvelousModel<Ophthalmosaurus>> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(MarvelousMenagerie.MOD_ID, "textures/entity/animal/ophthalmo/ophthalmo_armor.png");
    private static final ResourceLocation TEXTURE_CRACKED = new ResourceLocation(MarvelousMenagerie.MOD_ID, "textures/entity/animal/ophthalmo/ophthalmo_armor_cracked.png");
    private static final ResourceLocation TEXTURE_VERY_CRACKED = new ResourceLocation(MarvelousMenagerie.MOD_ID, "textures/entity/animal/ophthalmo/ophthalmo_armor_very_cracked.png");
