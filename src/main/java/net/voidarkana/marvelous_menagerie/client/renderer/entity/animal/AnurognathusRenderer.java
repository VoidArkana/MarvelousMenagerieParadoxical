...
import net.voidarkana.marvelous_menagerie.client.renderer.entity.layers.AnurognathusPatternLayer;
...
public class AnurognathusRenderer<T extends Anurognathus> extends MobRenderer<T, MarvelousModel<T>> {
    ...
    public AnurognathusRenderer(EntityRendererProvider.Context pContext) {
        ...
        this.addLayer(new AnurognathusPatternLayer<>(this, pContext));
    ...
    public ResourceLocation getTextureLocation(T pEntity) {
        return new ResourceLocation(MarvelousMenagerie.MOD_ID, "textures/entity/animal/anurognathus/"
