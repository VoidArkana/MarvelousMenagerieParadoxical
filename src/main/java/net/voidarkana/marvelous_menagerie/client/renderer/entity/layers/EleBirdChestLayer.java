...
@OnlyIn(Dist.CLIENT)
public class EleBirdChestLayer extends RenderLayer<ElephantBird, MarvelousModel<ElephantBird>> {

    public EleBirdChestLayer(RenderLayerParent<ElephantBird, MarvelousModel<ElephantBird>> pRenderer, EntityRendererProvider.Context pContext) {
        super(pRenderer);
    }
