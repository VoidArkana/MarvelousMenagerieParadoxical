...
public class RoachRenderer extends MobRenderer<Apthoroblattina, RoachModel<Apthoroblattina>> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(MarvelousMenagerie.MODID,"textures/entity/animal/apthoroblattina/apthoroblattina.png");
