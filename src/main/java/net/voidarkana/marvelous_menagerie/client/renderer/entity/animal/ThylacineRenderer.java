...
public class ThylacineRenderer extends MobRenderer<Thylacine, ThylacineModel<Thylacine>> {
    ...
    private static final ResourceLocation BASE_TEXTURE = new ResourceLocation(MarvelousMenagerie.MOD_ID, "textures/entity/animal/thylacine/thylacine.png");
    private static final ResourceLocation METRO_TEXTURE = new ResourceLocation(MarvelousMenagerie.MOD_ID, "textures/entity/animal/thylacine/thylacine_metropolitan.png");
