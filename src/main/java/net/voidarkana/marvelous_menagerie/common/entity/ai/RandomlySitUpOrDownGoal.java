...
public class RandomlySitUpOrDownGoal extends Goal {
    private final MarvelousAnimal mob;
    private int nextMove;
    final int sittingUpInterval;
    final int sittingDownInterval;

    public RandomlySitUpOrDownGoal(MarvelousAnimal mob, int interval) {
        this(mob, interval, interval);
    }

    public RandomlySitUpOrDownGoal(MarvelousAnimal mob, int gettingUpInterval, int sittingDownInterval) {
        this.mob = mob;
