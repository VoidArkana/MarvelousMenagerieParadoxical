...
public class TameableFollowOwnerGoal extends Goal {

    public static final int TELEPORT_WHEN_DISTANCE_IS = 12;
    private static final int MIN_HORIZONTAL_DISTANCE_FROM_PLAYER_WHEN_TELEPORTING = 2;
    private static final int MAX_HORIZONTAL_DISTANCE_FROM_PLAYER_WHEN_TELEPORTING = 3;
    private static final int MAX_VERTICAL_DISTANCE_FROM_PLAYER_WHEN_TELEPORTING = 1;
    private final TamableMarvelousAnimal tamable;
    ...
    public TameableFollowOwnerGoal(TamableMarvelousAnimal pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
    ...
    public boolean canUse() {
        ...
        if (livingentity == null) {
            ...
            return this.tamable.shouldFollow();
        }
    }
    ...
    public boolean canContinueToUse() {
        if (this.navigation.isDone()) {
            ...
            return !(this.tamable.distanceToSqr(this.owner) <= (double)(this.stopDistance * this.stopDistance)) && this.tamable.shouldFollow();
        }
    }
