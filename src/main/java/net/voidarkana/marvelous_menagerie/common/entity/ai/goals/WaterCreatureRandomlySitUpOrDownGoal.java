...
public class WaterCreatureRandomlySitUpOrDownGoal extends Goal {
    private final MarvelousWaterAnimal mob;
    private int nextMove;
    final int sittingUpInterval;
    final int sittingDownInterval;

    public WaterCreatureRandomlySitUpOrDownGoal(MarvelousWaterAnimal mob, int interval) {
        this(mob, interval, interval);
    }

    public WaterCreatureRandomlySitUpOrDownGoal(MarvelousWaterAnimal mob, int gettingUpInterval, int sittingDownInterval) {
        this.mob = mob;
