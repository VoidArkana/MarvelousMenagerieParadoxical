...
public class MarvelousLandMoveControl extends MoveControl {

    final float maxYRot;
    final Mob animal;

    public MarvelousLandMoveControl(Mob pMob, float maxYRot) {
        super(pMob);
    ...
    public void tick() {
        if (this.animal instanceof ISittingAnimal pAnimal && this.animal instanceof PathfinderMob mob){
            if (this.operation == MoveControl.Operation.MOVE_TO && !mob.isLeashed()) {
                pAnimal.standUp();
            }
        }
