...
public class FlightPathNavigationNoSpin extends FlyingPathNavigation {
    private float distancemodifier = 0.75F;

    public FlightPathNavigationNoSpin(Mob entitylivingIn, Level worldIn) {
        super(entitylivingIn, worldIn);
    }

    public FlightPathNavigationNoSpin(Mob entitylivingIn, Level worldIn, float distancemodifier) {
        super(entitylivingIn, worldIn);
