...
public class VegetationBonemealPatchFeature extends Feature<NetherForestVegetationConfig> {
    public VegetationBonemealPatchFeature(Codec<NetherForestVegetationConfig> p_66361_) {
        super(p_66361_);
    }
