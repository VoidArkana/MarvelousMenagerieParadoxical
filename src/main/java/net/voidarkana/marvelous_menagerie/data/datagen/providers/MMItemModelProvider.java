...
public class MMItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(MMItems.INOSTRANCEVIA_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));

        simpleItem(MMItems.LYSTRO_FOSSIL);
        withExistingParent(MMItems.LYSTROSAURUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        simpleItem(MMItems.LYSTRO_CHOP);
        simpleItem(MMItems.COOKED_LYSTRO_CHOP);
        ...
        withExistingParent(MMItems.KELENKEN_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        ...
        withExistingParent(MMItems.DODO_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        ...
        simpleItem(MMItems.ELEPHANT_BIRD_EGG);
        simpleItem(MMItems.EGG_SHELLMET);
        simpleItem(MMItems.EGG_SHELL_FRAGMENT);
        withExistingParent(MMItems.ELE_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
        ...
        simpleItem(MMItems.DIPLOCAULUS_FOSSIL);
        simpleItem(MMItems.DIPLOCAULUS_BUCKET);
        withExistingParent(MMItems.DIPLOCAULUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));

        simpleItem(MMItems.FLUBBER_FOSSIL);
        simpleItem(MMItems.BABY_FLUBBER_BUCKET);
        withExistingParent(MMItems.FLUBBER_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));

        simpleItem(MMItems.MYOTRAGUS_FOSSIL);
        withExistingParent(MMItems.MYOTRAGUS_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));

        simpleItem(MMItems.TIKTAALIK_FOSSIL);
        simpleItem(MMItems.TIKTAALIK_BUCKET);
        withExistingParent(MMItems.TIKTAALIK_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));

        simpleItem(MMItems.ANURO_FOSSIL);
        simpleItem(MMItems.ANURO_BUCKET);
        withExistingParent(MMItems.ANURO_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));

        simpleItem(MMItems.ATROCIRAPTOR_FOSSIL);
        withExistingParent(MMItems.ATROCIRAPTOR_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));

        withExistingParent(MMItems.WATCHER_SPAWN_EGG.getId().getPath(), mcLoc("item/template_spawn_egg"));
