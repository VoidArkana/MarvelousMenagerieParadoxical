...
public class MMBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(MMBlocks.CHRONO_PEDESTAL_BOOK.get());
        this.dropSelf(MMBlocks.CHRONO_ALTAR_BOOK.get());
...
//                createPotFlowerItemTable(MMBlocks.ARAUCARIOXYLON_SAPLING.get()));
        ...
        this.dropSelf(MMBlocks.LYSTRO_EGG.get());
        this.dropWhenSilkTouch(MMBlocks.LYSTRO_EGG_FRAGMENTS.get());
    }
